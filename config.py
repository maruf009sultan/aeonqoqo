# REQUIRED CONFIG
BOT_TOKEN = "7595286719:AAGingf7CN7OH9LzXXfkY6snSV2WACLVxC8"
OWNER_ID = 5631774748
TELEGRAM_API = 23995611
TELEGRAM_HASH = "a1b94f10b912c9d732c320f9c73d73dc"

# Recommended for persisting settings, RSS feeds, and task history. Essential for some features.
DATABASE_URL = "mongodb+srv://jammesop007:qEKm1KhiFOK1xMts@cluster0.kuhd3xq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"

# OPTIONAL CONFIG
TG_PROXY = {}  # Example: {"scheme": "socks5", "hostname": "11.22.33.44", "port": 1234, "username": "user", "password": "pass"}
USER_SESSION_STRING = ""
CMD_SUFFIX = "2"  # Suffix to add to all bot commands
AUTHORIZED_CHATS = ""  # Space separated chat_id/user_id to authorize
SUDO_USERS = "5631774748 7384283560"  # Space separated user_id for sudo access
...
FSUB_IDS = "-1001938186758"  # Forced subscription channel IDs (comma-separated)
